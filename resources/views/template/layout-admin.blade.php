...
<head>
    ...
    {{-- Hema Brand Theme (loads last to guarantee override) --}}
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            ...
            {{-- Logo area (sidebar-width mirror) --}}
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img src="{{ asset('admin/img/profiles/avator1.jpg') }}" alt="profil">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        <div class="profilename">
                            ...
                            <a class="dropdown-item" href="{{ url('/profile') }}">
                                <i class="me-2" data-feather="user"></i>Profil Saya
                            </a>
                            <hr class="m-0">
                            <form action="{{ route('logout') }}" method="post">
                                @csrf
                                <button class="dropdown-item logout pb-0" type="submit">
        ...
        {{-- ═══════════════════════════════════════════
             SIDEBAR
             Menu hanya mencakup fitur yang berkorelasi
             langsung dengan alur kerja customer:
             Produk → Pesanan → Data Master
        ════════════════════════════════════════════ --}}
                    ...
                    <ul>
                        ...
                        <li class="active">
                            <a href="{{ url('dashboard') }}">
                                <img src="{{ asset('admin/img/icons/dashboard.svg') }}" alt="">
                                <span>Dashboard</span>
                            </a>
                        </li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);">
                                <img src="{{ asset('admin/img/icons/product.svg') }}" alt="">
                                <span>Produk</span>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);">
                                <img src="{{ asset('admin/img/icons/sales1.svg') }}" alt="">
                                <span>Pesanan</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                        ...
                        {{--
                            ✂ DIPRUNING (tidak relevan dengan alur customer):
                            - Report  (purchaseorderreport, inventoryreport, salesreport, invoicereport, purchasereport, supplierreport, customerreport)
