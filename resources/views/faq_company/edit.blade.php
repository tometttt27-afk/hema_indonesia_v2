...
<div class="page-header">
    <div class="page-title">
        ...
        <h4>Ubah FAQ</h4>
        <h6>Mengubah pertanyaan umum</h6>
    </div>
    <a href="{{ url('/faq-company') }}" class="btn btn-secondary btn-cancel-nav" data-form="form-edit-faq">
...
<div class="card">
    <div class="card-header">
        ...
        <h5 class="card-title mb-0">Form Ubah FAQ</h5>
        <span class="badge badge-brand">{{ $data->code_faq }}</span>
    </div>
    <div class="card-body">
        <form action="{{ route('faqCompanyPut',$data->code_faq) }}" method="post" id="form-edit-faq">
            @csrf @method('PUT')
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('title',$data->title) }}" name="title"
                               autocomplete="off" placeholder="Judul pertanyaan">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $data->code_faq }}" readonly name="code_faq"
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="6" class="form-control"
                                  placeholder="Tulis jawaban lengkap...">{{ old('description',$data->description) }}</textarea>
